...
RUNBOOK = [
    {
        "id": "rb-001",
        "trigger": {"component": "aitoearn-server", "symptom_contains": ["502", "crash", "unreachable"]},
        "action": "docker_restart",
        "command": {"action": "custom", "payload": {"command": ["docker", "restart", "aitoearn-server"], "timeout": 30}},
    ...
    },
    {
        ...
        "command": {"action": "custom", "payload": {"command": ["docker", "restart", "aitoearn-web"], "timeout": 30}},
        "verify": {"url": "http://localhost:6060/zh-CN/welcome", "expect_status": 200},
        "max_retries": 1,
        "cooldown_seconds": 60,
        "safe": True,
    },
    {
        ...
        "command": {"action": "custom", "payload": {"command": ["docker", "restart", "aitoearn-nginx"], "timeout": 30}},
        "verify": {"url": "http://localhost:8080/api/health", "expect_status": 200},
        "max_retries": 2,
        "cooldown_seconds": 30,
        "safe": True,
    },
    {
        ...
        "command": {"action": "custom", "payload": {"command": ["docker", "restart", "aitoearn-mongodb"], "timeout": 45}},
        "verify": None,
        "max_retries": 1,
