...
export const messages: Record<ResponseCode, Record<Locale, MessageValue>> = {
  ...
  [ResponseCode.ContentBriefNotFound]: {
    'en-US': 'Content brief not found',
    'zh-CN': '内容 Brief 不存在',
    'ja-JP': 'コンテンツ概要が見つかりません',
  },
  [ResponseCode.ContentBriefInvalid]: {
    'en-US': 'Content brief is invalid',
    'zh-CN': '内容 Brief 无效',
    'ja-JP': 'コンテンツ概要が無効です',
  },
  [ResponseCode.InterviewRouteFailed]: {
    'en-US': 'Failed to route interview',
    'zh-CN': '采访路由失败',
    'ja-JP': 'インタビュールーティングに失敗しました',
  },
  [ResponseCode.InterviewInProgress]: {
    'en-US': 'An interview is already in progress',
    'zh-CN': '已有进行中的采访会话',
    'ja-JP': '既にインタビューが進行中です',
  },
  [ResponseCode.BrandKnowledgeNotFound]: {
    'en-US': 'Brand knowledge not found',
    'zh-CN': '品牌知识库不存在',
    'ja-JP': 'ブランド知識ベースが見つかりません',
  },
  [ResponseCode.BrandKnowledgeExtractFailed]: {
    'en-US': 'Failed to extract brand knowledge',
    'zh-CN': '品牌信息提取失败',
    'ja-JP': 'ブランド情報の抽出に失敗しました',
  },
  [ResponseCode.SampleReverseFailed]: {
    'en-US': 'Failed to reverse-analyze samples',
    'zh-CN': '样本反推分析失败',
    'ja-JP': 'サンプル逆分析に失敗しました',
  },
  [ResponseCode.ContentGenerationFailed]: {
    'en-US': 'Content generation failed',
    'zh-CN': '内容生成失败',
    'ja-JP': 'コンテンツ生成に失敗しました',
  },
  [ResponseCode.QualityCheckFailed]: {
    'en-US': 'Quality check failed',
    'zh-CN': '质量检查失败',
    'ja-JP': '品質チェックに失敗しました',
  },
  [ResponseCode.PlatformRuleNotFound]: {
    'en-US': 'Platform rule not found',
    'zh-CN': '平台规则不存在',
    'ja-JP': 'プラットフォームルールが見つかりません',
  },
}
