    ...
    models: {
      ...
      video: {
        generation: [
          ...
          {
            name: 'minimax-h3',
            description: 'MiniMax H3（统一网关）',
            channel: 'unified-gateway',
            ...
            pricing: [
              ...
              { duration: 8, price: 65 },
              { duration: 9, price: 65 },
              { duration: 10, price: 65 },
              { duration: 11, price: 65 },
              { duration: 12, price: 65 },
              { duration: 13, price: 65 },
              { duration: 14, price: 65 },
              { duration: 15, price: 65 },
            ],
          },
        ],
      },
