...
build_time_vars = {
    ...
    'CONFIGURE_CFLAGS': '',
    'CONFIGURE_CFLAGS_NODIST': '-flto -fuse-linker-plugin -ffat-lto-objects -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden',
    'CONFIGURE_CPPFLAGS': '',
    'CONFIGURE_LDFLAGS': '',
    'CONFIGURE_LDFLAGS_NODIST': '-flto -fuse-linker-plugin -ffat-lto-objects -g',
    'CONFIGURE_LDFLAGS_NOLTO': '-fno-lto',
    'CONFIG_ARGS': "'--build=x86_64-linux-musl' '--enable-loadable-sqlite-extensions' '--enable-option-checking=fatal' '--enable-shared' '--with-lto' '--with-ensurepip' 'build_alias=x86_64-linux-musl'",
    ...
    'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -flto -fuse-linker-plugin -ffat-lto-objects -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -fPIC',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    ...
    'LIBHACL_CFLAGS': '-I./Modules/_hacl -I./Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE -fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -flto -fuse-linker-plugin -ffat-lto-objects -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -fPIC',
    'LIBHACL_HEADERS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-I./Modules/_decimal/libmpdec -DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1 -fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -flto -fuse-linker-plugin -ffat-lto-objects -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -fPIC',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    ...
    'MODULE__CTYPES_TEST_LDFLAGS': '-L/usr/lib/../lib -lffi -ldl -lm',
    ...
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -flto -fuse-linker-plugin -ffat-lto-objects -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -DPy_BUILD_CORE_BUILTIN',
    'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall',
    'PY_CFLAGS_NODIST': '-flto -fuse-linker-plugin -ffat-lto-objects -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc',
    'PY_COERCE_C_LOCALE': 1,
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -flto -fuse-linker-plugin -ffat-lto-objects -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -DPy_BUILD_CORE',
    'PY_CORE_LDFLAGS': '-flto -fuse-linker-plugin -ffat-lto-objects -g',
    'PY_CPPFLAGS': '-I. -I./Include',
    'PY_ENABLE_SHARED': 1,
    'PY_HAVE_PERF_TRAMPOLINE': 0,
    'PY_LDFLAGS': '',
    'PY_LDFLAGS_NODIST': '-flto -fuse-linker-plugin -ffat-lto-objects -g',
    'PY_LDFLAGS_NOLTO': '-fno-lto',
    'PY_SQLITE_ENABLE_LOAD_EXTENSION': 1,
    'PY_SQLITE_HAVE_SERIALIZE': 1,
    'PY_SSL_DEFAULT_CIPHERS': 1,
    'PY_SSL_DEFAULT_CIPHER_STRING': 0,
    'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -flto -fuse-linker-plugin -ffat-lto-objects -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC',
    'PY_SUPPORT_TIER': 0,
    'Py_DEBUG': 0,
    'Py_ENABLE_SHARED': 1,
    'Py_GIL_DISABLED': 0,
    ...
    'SETPGRP_HAVE_ARG': 0,
    'SHAREDMODS': 'Modules/array.cpython-314-x86_64-linux-musl.so Modules/_asyncio.cpython-314-x86_64-linux-musl.so Modules/_bisect.cpython-314-x86_64-linux-musl.so Modules/_csv.cpython-314-x86_64-linux-musl.so Modules/_heapq.cpython-314-x86_64-linux-musl.so Modules/_json.cpython-314-x86_64-linux-musl.so Modules/_lsprof.cpython-314-x86_64-linux-musl.so Modules/_pickle.cpython-314-x86_64-linux-musl.so Modules/_queue.cpython-314-x86_64-linux-musl.so Modules/_random.cpython-314-x86_64-linux-musl.so Modules/_remote_debugging.cpython-314-x86_64-linux-musl.so Modules/_struct.cpython-314-x86_64-linux-musl.so Modules/_interpreters.cpython-314-x86_64-linux-musl.so Modules/_interpchannels.cpython-314-x86_64-linux-musl.so Modules/_interpqueues.cpython-314-x86_64-linux-musl.so Modules/_zoneinfo.cpython-314-x86_64-linux-musl.so Modules/math.cpython-314-x86_64-linux-musl.so Modules/cmath.cpython-314-x86_64-linux-musl.so Modules/_statistics.cpython-314-x86_64-linux-musl.so Modules/_decimal.cpython-314-x86_64-linux-musl.so Modules/binascii.cpython-314-x86_64-linux-musl.so Modules/_bz2.cpython-314-x86_64-linux-musl.so Modules/_lzma.cpython-314-x86_64-linux-musl.so Modules/_zstd.cpython-314-x86_64-linux-musl.so Modules/zlib.cpython-314-x86_64-linux-musl.so Modules/_dbm.cpython-314-x86_64-linux-musl.so Modules/_gdbm.cpython-314-x86_64-linux-musl.so Modules/readline.cpython-314-x86_64-linux-musl.so Modules/_md5.cpython-314-x86_64-linux-musl.so Modules/_sha1.cpython-314-x86_64-linux-musl.so Modules/_sha2.cpython-314-x86_64-linux-musl.so Modules/_sha3.cpython-314-x86_64-linux-musl.so Modules/_blake2.cpython-314-x86_64-linux-musl.so Modules/_hmac.cpython-314-x86_64-linux-musl.so Modules/pyexpat.cpython-314-x86_64-linux-musl.so Modules/_elementtree.cpython-314-x86_64-linux-musl.so Modules/_codecs_cn.cpython-314-x86_64-linux-musl.so Modules/_codecs_hk.cpython-314-x86_64-linux-musl.so Modules/_codecs_iso2022.cpython-314-x86_64-linux-musl.so Modules/_codecs_jp.cpython-314-x86_64-linux-musl.so Modules/_codecs_kr.cpython-314-x86_64-linux-musl.so Modules/_codecs_tw.cpython-314-x86_64-linux-musl.so Modules/_multibytecodec.cpython-314-x86_64-linux-musl.so Modules/unicodedata.cpython-314-x86_64-linux-musl.so Modules/fcntl.cpython-314-x86_64-linux-musl.so Modules/grp.cpython-314-x86_64-linux-musl.so Modules/mmap.cpython-314-x86_64-linux-musl.so Modules/_posixsubprocess.cpython-314-x86_64-linux-musl.so Modules/resource.cpython-314-x86_64-linux-musl.so Modules/select.cpython-314-x86_64-linux-musl.so Modules/_socket.cpython-314-x86_64-linux-musl.so Modules/syslog.cpython-314-x86_64-linux-musl.so Modules/termios.cpython-314-x86_64-linux-musl.so Modules/_posixshmem.cpython-314-x86_64-linux-musl.so Modules/_multiprocessing.cpython-314-x86_64-linux-musl.so Modules/_ctypes.cpython-314-x86_64-linux-musl.so Modules/_curses.cpython-314-x86_64-linux-musl.so Modules/_curses_panel.cpython-314-x86_64-linux-musl.so Modules/_sqlite3.cpython-314-x86_64-linux-musl.so Modules/_ssl.cpython-314-x86_64-linux-musl.so Modules/_hashlib.cpython-314-x86_64-linux-musl.so Modules/_uuid.cpython-314-x86_64-linux-musl.so Modules/_tkinter.cpython-314-x86_64-linux-musl.so Modules/xxsubtype.cpython-314-x86_64-linux-musl.so Modules/_xxtestfuzz.cpython-314-x86_64-linux-musl.so Modules/_testbuffer.cpython-314-x86_64-linux-musl.so Modules/_testinternalcapi.cpython-314-x86_64-linux-musl.so Modules/_testcapi.cpython-314-x86_64-linux-musl.so Modules/_testlimitedcapi.cpython-314-x86_64-linux-musl.so Modules/_testclinic.cpython-314-x86_64-linux-musl.so Modules/_testclinic_limited.cpython-314-x86_64-linux-musl.so Modules/_testimportmultiple.cpython-314-x86_64-linux-musl.so Modules/_testmultiphase.cpython-314-x86_64-linux-musl.so Modules/_testsinglephase.cpython-314-x86_64-linux-musl.so Modules/_ctypes_test.cpython-314-x86_64-linux-musl.so Modules/xxlimited.cpython-314-x86_64-linux-musl.so Modules/xxlimited_35.cpython-314-x86_64-linux-musl.so',
    'SHELL': '/bin/sh -e',
    'SHLIBS': '-ldl',
    'SHLIB_SUFFIX': '.so',
