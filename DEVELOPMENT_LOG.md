...
> 最后更新: 2026-06-01 | 当前阶段: Phase 3 完成，总进度 ~65%
...
| 路径 | 用途 |
|------|------|
| `D:\king2046\` | 🔧 **AiBrand 工作区** — 项目管理文档、任务追踪 |
| `C:\Users\XIAOMI\AiToEarn\` | 📦 **源码仓库** — 前端 + 后端 + Docker 编排 |
| `C:\Users\XIAOMI\AiToEarn\project\aitoearn-web\` | 🖥️ 前端 (Next.js 14, 端口 6060) |
| `C:\Users\XIAOMI\AiToEarn\project\aitoearn-backend\` | ⚙️ 后端 (NestJS Nx monorepo) |
| `C:\Users\XIAOMI\AiToEarn\project\openmontage-bridge\` | 🎬 视频制作桥接 (Python FastAPI, 端口 8001) |
...
docker ps                                            # 查看运行中的容器
docker compose -f C:/Users/XIAOMI/AiToEarn/docker-compose.yml up -d   # 启动全部服务
...
# ── 后端开发 ──
cd C:\Users\XIAOMI\AiToEarn\project\aitoearn-backend
...
# ── Git ──
git -C C:/Users/XIAOMI/AiToEarn log --oneline -5     # 查看源码提交
git -C D:/king2046 log --oneline                     # 查看工作区提交
